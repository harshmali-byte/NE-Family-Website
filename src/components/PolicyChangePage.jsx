...
function PolicyChangePage() {
  ...
  const options = [
    ...
    { label: t.policy.text, icon: faMobileScreenButton, href: 'sms:+15086722997?body=Hi%2C%20I%20need%20help%20with%20a%20policy%20change.' },
    { label: t.policy.whatsapp, icon: faWhatsapp, href: 'https://wa.me/15086722997?text=Hi%2C%20I%20need%20help%20with%20a%20policy%20change.' },
