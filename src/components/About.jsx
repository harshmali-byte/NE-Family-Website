...
function About() {
  return (
    <section
      className="border-t border-app-border bg-app-card"
      id="about"
    >
      <div className="mx-auto grid w-full max-w-7xl items-center gap-10 px-6 py-14 md:grid-cols-2 md:px-10">
        ...
        <div className="max-w-3xl">
          <h2 className="text-2xl font-bold text-app-text md:text-4xl leading-tight">
            New England Family Insurance & Financial Solutions Inc.
          </h2>

          {/* divider */}
          <div className="mt-3 h-1 w-20 bg-app-primary" />

          <div className="mt-6 space-y-4 text-sm leading-7 text-app-text-muted md:text-base md:leading-8">
