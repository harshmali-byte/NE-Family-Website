function TrustSection({ trustMetrics }) {
  return (
    <section className="border-t border-[var(--color-border)] bg-[var(--color-surface)] py-12 md:py-14" id="reviews">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 md:px-10">
        <article className="card-surface-light interactive-card interactive-card-light p-6 md:p-10">
          ...
          <div className="mx-auto mt-2 h-[3px] w-full max-w-3xl rounded-full bg-[var(--color-primary)]" />
