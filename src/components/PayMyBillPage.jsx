...
function PayMyBillPage() {
  const { t } = useI18n()
  const options = [
    { label: t.policy.text, icon: faMobileScreenButton, href: 'sms:+918120270109?body=Hi%2C%20I%20need%20help%20with%20my%20bill.' },
    { label: t.policy.whatsapp, icon: faWhatsapp, href: 'https://wa.me/918120270109?text=Hi%2C%20I%20need%20help%20with%20my%20bill.' },
